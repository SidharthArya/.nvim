...
nmap <silent> <Space>lD <Plug>(coc-type-definition)
...
autocmd BufNew,BufEnter *.json,*.vim,*.lua,*.ts,*.py execute "silent! CocEnable"
autocmd BufLeave *.json,*.vim,*.lua,*.ts,*.py execute "silent! CocDisable"
